...
const Contact = () => {
  return (
    <div id="contact" className="section w-full">
      ...
      <p className="max-w-prose">If you would like to see more of my work, I
        actively contribute to open-source projects on <Link
          text='GitHub' to='#' />, where I also
      ...
      <br />
      <ul>
        <li><Link text='Email' to='#' /></li>
        <li><Link text='Linkedin' to='#' /></li>
        <li><Link text='GitHub' to='#' /></li>
        <li><Link text='X/Twitter' to='#' /></li>
      </ul>
    </div >
  );
};
